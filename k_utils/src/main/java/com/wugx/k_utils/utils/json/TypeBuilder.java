...
package com.wugx.k_utils.utils.json;

import com.wugx.k_utils.utils.json.typeimpl.ParameterizedTypeImpl;
import com.wugx.k_utils.utils.json.typeimpl.WildcardTypeImpl;
import com.wugx_mvp.app.utils.json.exception.TypeException;
 ...
 *         .build();
 *
 * 用法二: List<? super String>
 * Type type = TypeBuilder
 *         .newInstance(List.class)
 *         .addTypeParamSuper(String.class)
 *         .build();
 *
 * 用法三:List<? extends CharSequence>
 * Type type = TypeBuilder
 *         .newInstance(List.class)
 *         .addTypeParamExtends(CharSequence.class)
 *         .build();
 *
 * 用法四: Map<String, String[]>
 * Type type = TypeBuilder
 *         .newInstance(HashMap.class)
 *         .addTypeParam(String.class)
 *         .addTypeParam(String[].class)
 *         .build();
 * 用法五: Map<String, List<String>>
 * Type type = TypeBuilder
